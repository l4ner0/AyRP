...
<head>
  ...
  <link rel="stylesheet" href="<?php echo HTML_DIR; ?>plugins/iCheck/all.css">

  <link rel="stylesheet" href="<?php echo HTML_DIR; ?>bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="<?php echo HTML_DIR; ?>dist/css/skins/_all-skins.min.css">

  <link rel="stylesheet" href="<?php echo HTML_DIR; ?>plugins/timepicker/bootstrap-timepicker.min.css">
  <!-- Morris chart -->
  ...
  <link rel="stylesheet" href="<?php echo HTML_DIR; ?>bower_components/select2/dist/css/select2.min.css">
  ...
  <script src="vistas/js/botonesSidebar.js"></script>
