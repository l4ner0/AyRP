...
<head>
  ...
  <script src="vistas/paginas/login/ajax/login.js"></script>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Identificate para iniciar tu sesión</p>

    <form onkeypress="return runScriptLogin(event)">
      <div class="form-group has-feedback">
        <input type="email" class="form-control" id="login_correo" placeholder="Correo">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" id="login_pass" placeholder="Contraseña">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" id="login_sesion"> Recordarme
            </label>
          </div>
        </div>
        <!-- /.col -->
        <div class="col-xs-12">
          <br>
          <input type="button" class="btn btn-primary btn-block btn-flat" onclick="goLogin()" value="Iniciar Sesión"></input>
        </div>
        <!-- /.col -->
      </div>
    </form>
    <br>
    <p>¿No tienes cuenta aún? <a href="./?view=registro"> Registrate</a></p><br>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
